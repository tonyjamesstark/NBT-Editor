...
`./gradlew build`. JUnit 5 runs over the pure-JVM slice only: fourteen test classes under
`src/test/java/`, 110 tests. Anything that touches registries, `Minecraft.getInstance()` or the run
