...
- [ ] 9. Extract `FindAndReplaceWidget` and `EventEditorWidget` into their own files
- [ ] 10. Retire `TextInst` / `IdentifierInst` pass-throughs; keep the format-unification core
- [ ] 11. Partition `MainUtil`
- [ ] 12. Create `CONTEXT.md` and `docs/adr/`
