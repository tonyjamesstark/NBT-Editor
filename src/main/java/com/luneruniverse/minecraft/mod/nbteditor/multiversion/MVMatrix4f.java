...
public class MVMatrix4f {
	...
	public static final Class<?> Matrix4f_class = Reflection.getClass("org.joml.Matrix4f");
	public static final Class<?> Matrix4fc_class = Reflection.getClass("org.joml.Matrix4fc");
	...
	public MVMatrix4f copy() {
		return new MVMatrix4f(Reflection.newInstance(Matrix4f_class, new Class<?>[] {Matrix4fc_class}, value));
	}
	...
	public void applyToPositionMatrix(MatrixStack matrices) {
		matrices.multiplyPositionMatrix((Matrix4f) value);
	}
