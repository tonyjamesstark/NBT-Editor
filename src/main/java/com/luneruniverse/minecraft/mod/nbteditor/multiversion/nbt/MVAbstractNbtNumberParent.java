...
public interface MVAbstractNbtNumberParent {
	...
	static final Supplier<Reflection.MethodInvoker> AbstractNbtNumber_byteValue =
			Reflection.getOptionalMethod(NumericTag.class, "method_10698", MethodType.methodType(byte.class));
	...
	static final Supplier<Reflection.MethodInvoker> AbstractNbtNumber_shortValue =
			Reflection.getOptionalMethod(NumericTag.class, "method_10696", MethodType.methodType(short.class));
	...
	static final Supplier<Reflection.MethodInvoker> AbstractNbtNumber_intValue =
			Reflection.getOptionalMethod(NumericTag.class, "method_10701", MethodType.methodType(int.class));
	...
	static final Supplier<Reflection.MethodInvoker> AbstractNbtNumber_longValue =
			Reflection.getOptionalMethod(NumericTag.class, "method_10699", MethodType.methodType(long.class));
	...
	static final Supplier<Reflection.MethodInvoker> AbstractNbtNumber_floatValue =
			Reflection.getOptionalMethod(NumericTag.class, "method_10700", MethodType.methodType(float.class));
	...
	static final Supplier<Reflection.MethodInvoker> AbstractNbtNumber_doubleValue =
			Reflection.getOptionalMethod(NumericTag.class, "method_10697", MethodType.methodType(double.class));
	...
	static final Supplier<Reflection.MethodInvoker> AbstractNbtNumber_numberValue =
			Reflection.getOptionalMethod(NumericTag.class, "method_10702", MethodType.methodType(Number.class));
